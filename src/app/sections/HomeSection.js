  ...
  return (
    <section id='home' className='overflow-hidden'>
      <div  className='bg-[url("/hero-bg.png")] bg-cover bg-center h-screen w-screen flex flex-col items-center justify-center gap-5 md:gap-6 lg:gap-8 2xl:gap-16 pt-20'>
        ...
        <p data-aos="zoom-out"  data-aos-duration="700" data-aos-easing="ease-out-cubic" className='text-customWhite text-xs md:text-lg lg:text-2xl 2xl:text-4xl font-medium'>A MACHINE LEARNING AND SQL ENGINEER</p>
        <p data-aos="zoom-out"  data-aos-duration="700" data-aos-easing="ease-out-cubic" className='text-customBlue text-[0.6rem] md:text-base lg:text-lg 2xl:text-3xl font-medium'>AND THIS IS MY PORTFOLIO</p>
      </div>
    </section>
  )
}
